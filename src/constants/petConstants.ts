...
export const petBonusMap: {
  [key: string]: { uniqueName: string; bonus: string; bonusValue: number };
} = {
  // Cats
  ...
  australianshepherd_r2: {
    uniqueName: "Australian Shepherd",
    bonus: "ChildSpecialBoost",
    bonusValue: 1,
  },
  australianshepherd_r: {
    uniqueName: "Australian Shepherd",
    bonus: "ChildSpecialBoost",
    bonusValue: 2,
  },
  ...
  germanpointer_l2: {
    uniqueName: "Cocoa Bean",
    bonus: "FasterWastelandReturnSpeed",
    bonusValue: 4,
  },
