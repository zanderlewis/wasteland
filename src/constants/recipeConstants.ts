export const RECIPE_UNLOCKS = [
  ...
  "AlienBlaster_Tuned",
  "AlienDisintegrator",
  "AlienDisintegrator_Enhanced",
  "AlienDisintegrator_Hardened",
  ...
  "AssaultronHead",
  "AssaultronHead_Enhanced",
  "AssaultronHead_Hardened",
  "AssaultronHead_Rusty",
  "BBGun",
  "BBGun_Enhanced",
  "BBGun_Hardened",
  "BBGun_Rusty",
  "BOSAssaultRifle_ArmorPiercing",
  "BOSCasual",
  "BOSUniform",
  "BOSUniform_Advanced",
  "BOSUniform_Expert",
